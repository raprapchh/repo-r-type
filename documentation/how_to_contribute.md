...
```bash
git add .
git commit -m "feat(scope): add a short, meaningful commit message and respect the norme"
```

[Conventional Commit norme](https://www.conventionalcommits.org/en/v1.0.0/) 4. **Push your branch**
...
To trigger a new automatic release on GitHub (binaries + zip), follow these steps after merging your changes to the `main` branch:
...
3. **Push the Tag**:
   This push triggers the GitHub Actions "Release" job.
   ```bash
