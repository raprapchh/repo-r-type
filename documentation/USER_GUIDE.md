...
If everything went well, you should see two executable files in the root folder:
...
```bash
./r-type_client <HOST_IP> <PORT>
```

Example:
```bash
./r-type_client 192.168.1.42 4242
```
...
*Documentation written for R-Type - Version 1.0*
