...
inline std::vector<Level> getLevels() {
    return {Level{{Wave{{{"Monster_Wave_2_Left", -100.0f, 200.0f, 200.0f, 0.0f, 0.0f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 400.0f, 200.0f, 0.0f, 0.5f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 600.0f, 200.0f, 0.0f, 1.0f, 0.5f},
                   ...
                   Wave{{{"Monster_Wave_2_Left", -100.0f, 300.0f, 200.0f, 0.0f, 0.0f, 0.5f},
                         ...
                         {"Monster_Wave_2_Left", -100.0f, 700.0f, 200.0f, 0.0f, 0.0f, 0.5f},
                        ...
                        6.0f},
                   Wave{{{"Monster_Wave_2_Left", -100.0f, 100.0f, 200.0f, 0.0f, 0.0f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 200.0f, 200.0f, 0.0f, 0.5f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 300.0f, 200.0f, 0.0f, 1.0f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 400.0f, 200.0f, 0.0f, 1.5f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 500.0f, 200.0f, 0.0f, 2.0f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 600.0f, 200.0f, 0.0f, 2.5f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 700.0f, 200.0f, 0.0f, 3.0f, 0.5f},
                         {"Monster_Wave_2_Left", -100.0f, 800.0f, 200.0f, 0.0f, 3.5f, 0.5f},
                        ...
                        10.0f}}},
            Level{{Wave{{{"Monster_0_Right", 1980.0f, 100.0f, -400.0f, 0.0f, 0.0f, 0.5f},
